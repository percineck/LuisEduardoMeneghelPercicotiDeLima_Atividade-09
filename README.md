# LuisEduardoMeneghelPercicotiDeLima_Atividade-09

Atividade 09 - Cadastro de rotas e navegação entre páginas

Esta atividade consiste na execução das seguintes tarefas:

Mapear componentes à rotas no módulo de rotas.
Criar navegação entre páginas por meio de link ou botões.
Passar dados via hierarquia de componentes, ou seja, usando @Input ou @Output.
Passar dados entre componentes que representam diferentes telas via parâmetros de rotas. 
Empregar variáveis de template e a anotação ViewChild.
